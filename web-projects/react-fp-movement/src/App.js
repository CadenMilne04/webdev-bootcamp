...
function App() {
  return (
    <BaseScene>
      <BaseBox text={false} position={[3, 0.5, 0]} args={[2, 1, 2]} color="red" />
      <BaseBox text={false} position={[5, 0.5, 0]} args={[1.5, 2, 1.3]} color="orange" />
      <BaseBox text={false} position={[8, 0.5, 0]} args={[3, 1, 1.3]} color="green" />
      ...
      <ThreeModel args={[0.5, 2, 0.5]} scale={0.5} position={[0, 0, -10]} />
      <ThreeModel args={[0.5, 2, 0.5]} scale={0.5} position={[10, 0, 5]} />
      <POSModel args={[0.5, 2, 0.5]} scale={0.5} position={[-2, -.2, 0]}/>
      <Sky />
    </BaseScene>
  );
}
